...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setText("ex:160117733095");
...
static login jf=new login();
    ...
    void loginActionPerformed(double x,double y)
    {
        if (x==95 && y==123456)
        {
            jf.setVisible(true);
